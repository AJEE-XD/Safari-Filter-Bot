...
BOT_TOKEN = environ.get('BOT_TOKEN', "7708522448:AAF9imBxlj4gsl-RC8J6jD6gwZU5q7nwEc0")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002306948486').split()]
# post channel auto post new movie
POST_CHANNELS = list(map(int, (channel.strip() for channel in environ.get('POST_CHANNELS', '-1002486613099').split(','))))
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/me_miss_uhh')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Safaribotts')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002400433284))
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1002299448732)) # Group verify stats 
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002299448732)) # movies request channel, else log channel
